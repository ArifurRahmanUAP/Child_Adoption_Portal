...
<div class="site-wrap">
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="index.php" class="cd-signup"><span class="mr-2 icon-lock_outline"></span>Log In</a>
            </div>
    ...
    <section style="background-image: url('images/ban.jpg'); height:100px;">
     <div class="container">
        <h1 style="text-align: center;color: white;">Authority Log-in</h1>
      </div>
    </section>
