...
session_start();
  if(!isset($_SESSION['username']) )
      ...
      {
        $sql="SELECT ce.name as cname, c.* FROM centers as ce, child as c WHERE ce.id=c.center_id AND c.status!='Adopted';";
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li><a href="child.php" class="nav-link active">View Childs</a></li>
            </ul>
          </nav>
...
<br> <br>
  <div class="container">
    <h1 align="middle"><b>View Children's info</b></h1>
              <table id="table">
                <tr>
                 ...
                 while($row = mysqli_fetch_assoc($result))
                           {
                            ...
                            <tr>
                              ...
                              <td><?php echo "<img src=\"../center/image/". $row['image'] . "\"height=\"100\" width=\"100\" align=\"center\"/>"; ?></td>
