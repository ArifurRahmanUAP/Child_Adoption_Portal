...
if(!isset($_SESSION['email']))
{
  header('Location: ../login.php');
				...
				$u_id= $_SESSION['id'];
                $sql="SELECT c.id, c.date, c.status, u.name, u.contact, u.email, u.address  FROM consult as c, centers as u WHERE c.user_id ='$u_id' AND c.center_id=u.id AND c.status!='pending' ORDER BY c.id DESC ;";
...
?>            <table id="table">
              <tr>
                <td style="color:green;"><b>Your appointment requst for <?php echo $row['date'];?> to <?php echo $row['name'];?> has been approved <a href="sc-view.php?id=<?php echo $row['id']; ?>">click here</a> to view details</b></td>
              </tr>
              </table>
              <br>
<?php
 ...
 ?>
              <table id="table">
                  <tr>
                <td style="color:red;"><b>Your appointment requst for <?php echo $row['date'];?> to <?php echo $row['name'];?> has been Rejected</b></td>
                  </tr>
              </table>
              <br>
<?php
