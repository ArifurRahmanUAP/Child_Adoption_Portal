...
if(!isset($_SESSION['username']))
{
  header('Location: index.php');
                ...
                $sql="SELECT c.id, c.date, u.name, u.contact, u.email FROM consult as c, users as u WHERE c.center_id ='$center_id' AND u.id=c.user_id AND c.status='approved' ;";
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li><a href="appoinment.php" class="nav-link active">Appoinments</a></li>
...
<br> <br>
  <div class="container">
    <h2 align="middle"><b>Appoinment List</b></h2>
              ...
              <table id="table">
                <tr>
                  ...
                  <th>Requested<br>Date</th>
                    ...
                    echo "<h1 align=\"middle\">No recent appoinments<h1>";
                ?>
