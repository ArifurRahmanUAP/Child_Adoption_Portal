                 ...
                 while($row = mysqli_fetch_assoc($result))
                           {
                            ...
                            <tr>
                              ...
                              <td style="width:20%;"><a href="action/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">update</a>
                                <a href="action/remove.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">remove</a>
                              </td>
                            </tr>
                            <?php 
                            $serial++;
