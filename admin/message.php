...
<div class="site-wrap">
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        ...
        <li>   <a href="message.php" class="nav-link active">Messages</a></li>
            </ul>
          </nav>
...
<br> <br>
  <div class="container">
    <h3 align="middle"> Messages</h3><br>
        <table id="table">
          <tr>
            <th>Message ID</th>
            <th>Email</th>
              ...
              <?php
                 $sql="SELECT * FROM messages;";
                         ...
                         while($row = mysqli_fetch_assoc($result))
                                   {
                                    echo "<tr><td>". $row['id'] . "</td><td>" . $row['email']. "</td><td>". $row['name']. "</td><td>" .$row['msg'] . "</td></tr>";
                                   }
                            }
                            else
                               echo "No data found";
